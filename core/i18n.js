...
(function(){
  const DICT = {
    uk: {
      ...
      srv_place:'Місце', pl_own:'Наша церква', pl_other:'Інша церква', pl_basement:'Підвал', pl_pavilion:'Павільйон', pl_custom:'Інше', pl_custom_ph:'Впишіть місце',
      who_participates:'Хто бере участь', who_none:'Нікого не призначено', srv_translator:'Перекладач', blk_pick_person:'Обрати людину', people_manage:'Керувати людьми', srv_pick_person:'Обрати людину',
      ...
      srv_blocks:'Блоки служіння', blk_add:'Додати блок', blk_person:'Хто виконує', blk_note_ph:'Нотатка', blk_songs:'Пісні', blk_prayer:'Молитва', blk_preaching:'Проповідь', blk_media:'Медіа', blk_note:'Нотатка',
    ...
    en: {
      ...
      srv_place:'Place', pl_own:'Our church', pl_other:'Another church', pl_basement:'Basement', pl_pavilion:'Pavilion', pl_custom:'Other', pl_custom_ph:'Enter place',
      who_participates:'Who participates', who_none:'Nobody assigned', srv_translator:'Translator', blk_pick_person:'Pick a person', people_manage:'Manage people', srv_pick_person:'Pick a person',
      ...
      srv_blocks:'Service blocks', blk_add:'Add block', blk_person:'Who leads', blk_note_ph:'Note', blk_songs:'Songs', blk_prayer:'Prayer', blk_preaching:'Preaching', blk_media:'Media', blk_note:'Note',
